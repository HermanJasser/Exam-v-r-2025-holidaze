    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Create account">
      <form onSubmit={handleRegister} className="flex w-[350px] flex-col gap-4">
        ...
        <div>
          ...
          />
          {errors.name && (
            <p className="text-redPrim text-sm mt-1">{errors.name}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.email && (
            <p className="text-redPrim text-sm mt-1">{errors.email}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.password && (
            <p className="text-redPrim text-sm mt-1">{errors.password}</p>
          )}
        </div>
