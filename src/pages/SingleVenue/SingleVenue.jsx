...
export default function SingleVenue() {
  ...
  if (loading)
    return (
      <div className="text-center py-10 mb-[1000px]">
        <Loading />
      </div>
    );
  if (error)
  ...
  return (
    <div className="max-w-4xl mx-auto my-20 p-4 space-y-8">
      ...
      <div className="flex flex-col  justify-between items-start">
        ...
        <h1 className="text-4xl font-bold text-textPrim mt-1 max-w-full whitespace-normal break-words">
          {name}
        </h1>
      ...
      <div>
        ...
        <p className="text-textPrim leading-relaxed overflow-hidden">
          {description}
        </p>
      </div>
